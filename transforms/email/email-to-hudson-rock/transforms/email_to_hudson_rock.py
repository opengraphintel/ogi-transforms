...
class EmailToHudsonRock(BaseTransform):
    name = "email_to_hudson_rock"
    display_name = "Email to Hudson Rock"
    description = (
        "Checks an email address against Hudson Rock's free infostealer "
        "intelligence and maps any compromise to graph entities"
    )
...
# The search-by-email and search-by-username endpoints return the same
