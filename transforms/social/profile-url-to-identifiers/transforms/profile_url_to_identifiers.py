...
class ProfileURLToIdentifiers(BaseTransform):
    name = "profile_url_to_identifiers"
    ...
    settings = [
        TransformSetting(name="timeout_seconds", display_name="Timeout Seconds", description="Per-request timeout for fetching the profile page", default="15", field_type="integer", min_value=3, max_value=60),
